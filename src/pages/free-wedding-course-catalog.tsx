...
const FreeWeddingCourseCatalog: React.FC = () => {
  ...
  return (
    <Layout>
      ...
      <Background image="weddingTable">
        <section>
          <Container id="catalog-form">
            <h1 style={{ textTransform: 'uppercase' }} className="text-center text-white text-shadow mb-4">Become a<br /><strong>Certified Wedding Planner</strong></h1>
            <Row>
      ...
      <section style={{ background: '#ededed' }}>
        <Container>
          <h2 className="h4 mb-4 text-center">QC Event School Will Help You Launch Your Wedding Planning Career!</h2>
...
export default FreeWeddingCourseCatalog;
