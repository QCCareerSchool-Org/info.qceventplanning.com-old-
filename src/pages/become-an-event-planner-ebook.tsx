          ...
          <Container id="catalog-form">
            <Row className="align-items-center">
              <Col xs="12" lg="6" className="order-1 order-lg-2 text-center text-lg-left">
                <h1 style={{ textTransform: 'uppercase' }} className="text-white text-shadow mb-4"><small style={{ fontSize: '60%' }}>Get the Free eBook</small><br />Become an Event Planner</h1>
                ...
                <Card>
                  <Card.Body>
                    <div className="p-0 p-md-4">
                      <Card.Title className="text-center mb-4">Download the Free eBook</Card.Title>
